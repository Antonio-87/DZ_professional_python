...
def input_doc_owner_name():
    return input('Введите имя владельца документа- ')


def input_doc_shelf_namber():
    return input('Введите номер полки для хранения - ')
...
def add_new_doc(user_doc_number, doc_type, doc_owner_name, doc_shelf_number):
    new_doc = {
        "type": doc_type,
        "number": user_doc_number,
        "name": doc_owner_name
    }
    documents.append(new_doc)
    append_doc_to_shelf(user_doc_number, doc_shelf_number)
    return doc_shelf_number
...
def secretary_program_start():
    ...
    while True:
        ...
        if user_command == 'p':
            user_doc_number = input_doc_number()
            ...
            doc_owner_name = input_doc_owner_name()
            doc_shelf_number = input_doc_shelf_namber()
            new_doc_shelf_number = add_new_doc(user_doc_number, doc_type, doc_owner_name, doc_shelf_number)
            ...
            user_doc_number = input_doc_number()
            user_shelf_number = input_doc_shelf_namber()
            move_doc_to_shelf(user_doc_number, user_shelf_number)
        elif user_command == 'as':
            shelf_number = input_doc_shelf_namber()
